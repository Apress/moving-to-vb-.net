...
Class Account
    ...
    Public AccountHolder As IAccountHolder
    ...
    Public Overridable Function ChargeAccount() As Decimal Implements IChargeable.ChargeFee
    ...
    Public ReadOnly Property Description() As String Implements IChargeable.Description
        Get
