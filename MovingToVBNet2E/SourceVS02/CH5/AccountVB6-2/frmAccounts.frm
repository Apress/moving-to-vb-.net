...
Private Sub cmdTest_Click()
    ...
    Dim Idx As Integer
    Dim Accounts(9) As Account
    Dim ck As CheckingAccount
    Dim sv As SavingsAccount
    For Idx = 0 To 9
        If Rnd() < 0.5 Then
            Set ck = New CheckingAccount
            Set Accounts(Idx) = ck.m_Account
        Else
            Set sv = New SavingsAccount
            Set Accounts(Idx) = sv.m_Account
        End If
